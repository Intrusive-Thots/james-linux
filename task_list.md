...
- [x] Full Agent (~3k lines), Orchestrator (~2.4k lines), and parrot.py wrappers restored from 8d84715 into package layout.
- Intent patterns and models remain in separate package modules for stable imports.
