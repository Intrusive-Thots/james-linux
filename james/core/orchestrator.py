                ...
                if settings_file.exists():
                    ...
                    if sudo_pass:
                        try:
                            ...
                            logger.warning(
                                "Could not migrate sudo password to keyring: %s", e
                            )
    ...
    def crack_wpa_smart(
        ...
        if ssid:
            ...
            try:
                ...
                count = os.stat(ssid_list).st_size // 10
        ...
        try:
            ...
            count = os.stat(wifi_common).st_size // 10
        ...
        try:
            ...
            count = os.stat(numeric_list).st_size // 10
