...
from PyQt5.QtWidgets import (
    ...
    QLabel, QPlainTextEdit, QProgressBar, QMessageBox, QSplitter, 
    QStatusBar, QTabWidget, QGroupBox, QDialog, QTextEdit,
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, orchestrator: Orchestrator):
        ...
        self._append_log("JAMES Initialized. Select an interface in the Cracker tab to begin.")
    ...
    # ── Utilities ──
    def kill_james(self):
        reply = QMessageBox.question(self, "Kill JAMES", "Abort all operations and restore networking?",
